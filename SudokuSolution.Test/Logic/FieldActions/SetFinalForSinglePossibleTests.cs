...
[TestFixture]
public class SetFinalForSinglePossibleTests
{
	private ISetFinalForSinglePossible _setFinalForSinglePossible;
	private ISetFinalForSinglePossible _setFinalForSinglePossibleWithoutCleanPossible;

	[OneTimeSetUp]
	public void CreateService()
	{
		_setFinalForSinglePossible = new SetFinalForSinglePossible(new CleanPossibleFacade(new CleanPossibleByRow(), new CleanPossibleByFinal(), new CleanPossibleByColumn()));
		...
		_setFinalForSinglePossibleWithoutCleanPossible = new SetFinalForSinglePossible(cleanPossibleFacade.Object);
	}
	...
	public void ExecuteWithFieldTest()
	{
		...
		field.Cells[1, 1].ShouldBeNotFinal(field.MaxValue, 1, 2, 3, 6);
		...
		field.Cells[2, 1].ShouldBeNotFinal(field.MaxValue, 1, 2, 3, 5, 6);
		...
		field.Cells[4, 1].ShouldBeNotFinal(field.MaxValue, 3, 5, 6);
		...
		field.Cells[6, 0].ShouldBeNotFinal(field.MaxValue, 2, 3, 4, 6);
		field.Cells[6, 1].ShouldBeFinal(7);
		field.Cells[6, 2].ShouldBeNotFinal(field.MaxValue, 2, 3, 4, 6, 8);
		field.Cells[6, 3].ShouldBeNotFinal(field.MaxValue, 1, 6);
		...
		field.Cells[7, 0].ShouldBeNotFinal(field.MaxValue, 2, 3, 6);
		field.Cells[7, 1].ShouldBeNotFinal(field.MaxValue, 2, 3, 6);
		...
		field.Cells[8, 1].ShouldBeFinal(9);
		field.Cells[8, 2].ShouldBeNotFinal(field.MaxValue, 4, 8);
		field.Cells[8, 3].ShouldBeFinal(3);
		field.Cells[8, 4].ShouldBeFinal(2);
		field.Cells[8, 5].ShouldBeFinal(7);
		field.Cells[8, 6].ShouldBeNotFinal(field.MaxValue, 4, 5);
		field.Cells[8, 7].ShouldBeFinal(6);
		field.Cells[8, 8].ShouldBeNotFinal(field.MaxValue, 4, 5, 8);
	}
	...
	{
		var field = TestFieldHelper.GetSmallTestFieldWithPossible();
		_setFinalForSinglePossibleWithoutCleanPossible.Execute(field);
		_setFinalForSinglePossibleWithoutCleanPossible.Execute(field);
		_setFinalForSinglePossibleWithoutCleanPossible.Execute(field);
