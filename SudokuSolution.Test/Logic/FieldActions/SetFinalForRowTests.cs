...
namespace SudokuSolution.Test.Logic.FieldActions {
	...
	public class SetFinalForRowTests {
		...
		public void ExecuteWithFieldTest() {
			...
			field.Cells[0, 6].ShouldBeNotFinal(field.MaxValue, 1, 2);
			...
			field.Cells[2, 6].ShouldBeNotFinal(field.MaxValue, 1, 2, 3, 9);
			...
			field.Cells[3, 6].ShouldBeNotFinal(field.MaxValue, 3, 7);
			field.Cells[3, 7].ShouldBeFinal(9);
			field.Cells[3, 8].ShouldBeFinal(8);
			...
			field.Cells[5, 7].ShouldBeNotFinal(field.MaxValue, 1, 3, 7);
			field.Cells[5, 8].ShouldBeNotFinal(field.MaxValue, 1, 3);
			field.Cells[6, 0].ShouldBeNotFinal(field.MaxValue, 2, 3, 4, 6);
			field.Cells[6, 1].ShouldBeFinal(7);
			field.Cells[6, 2].ShouldBeNotFinal(field.MaxValue, 2, 3, 4, 6);
			...
			field.Cells[6, 7].ShouldBeFinal(8);
			field.Cells[6, 8].ShouldBeNotFinal(field.MaxValue, 1, 3, 9);
